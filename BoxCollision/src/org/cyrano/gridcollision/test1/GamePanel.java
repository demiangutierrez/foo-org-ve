package org.cyrano.gridcollision.test1;
...
public class GamePanel extends JPanel {
  ...
  private static final int POINT_RADIUS_BIG = 10;
  private static final int POINT_RADIUS_SML = 2;
  ...
  public static class GridColInfo {
  ...
  private List<GridColInfo> calculateHorPointList(Point beg, Point end, int gridSize) {
    //    Point beg = pt1.x < pt2.x ? pt1 : pt2;
    //    Point end = pt1.x < pt2.x ? pt2 : pt1;

    List<GridColInfo> ret = new ArrayList<GridColInfo>();
    ...
    if (beg.x < end.x) {
      ...
      for (int i = gridX; i < end.x; i += gridSize) {
        GridColInfo gci = new GridColInfo();
  ...
  private List<GridColInfo> calculateVerPointList(Point beg, Point end, int gridSize) {
    //    Point beg = pt1.x < pt2.x ? pt1 : pt2;
    //    Point end = pt1.x < pt2.x ? pt2 : pt1;
