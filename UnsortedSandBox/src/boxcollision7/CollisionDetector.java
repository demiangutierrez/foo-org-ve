...
public class CollisionDetector {
    ...
    if (boxYPos == BoxP.B1_B2_B1 || boxYPos == BoxP.B2_B1_B2 || //
      ...
      if (vRel < 0) {
        return new Point2D.Double( //
            -Double.MAX_VALUE, Math.abs(distCrashMin / (double) vRel));
      }
      ...
      if (vRel > 0) {
        return new Point2D.Double( //
            -Double.MAX_VALUE, Math.abs(distCrashMax / (double) vRel));
      }
    }
  ...
  private static BoxP calcBoxPos(Point p1, Point p2) {
  ...
  //  private static BoxP calcBoxXPos(Box box1, Box box2) {
  //    return calcBoxPos( //
  ...
  //  private static BoxP calcBoxYPos(Box box1, Box box2) {
  //    return calcBoxPos( //
