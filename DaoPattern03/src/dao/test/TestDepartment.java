...
public class TestDepartment extends TestCase {
  ...
  private boolean compareDO(DepartmentDTO departmentDTO1, DepartmentDTO departmentDTO2) {
    boolean ret = true;
  ...
  public void testListAll() throws Exception {
    ...
    assertTrue(compareDO(departmentDTO1, (DepartmentDTO) departmentList.get(0)));
    assertTrue(compareDO(departmentDTO2, (DepartmentDTO) departmentList.get(1)));
  ...
  public void testListAllLimOff() throws Exception {
    ...
    assertEquals(1, departmentList.size());
    assertTrue(compareDO(departmentDTO2, (DepartmentDTO) departmentList.get(0)));
