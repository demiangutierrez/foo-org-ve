...
public class TestEmployee extends TestCase {
  ...
  private boolean compareDO(EmployeeDTO employeeDTO1, EmployeeDTO employeeDTO2) {
    boolean ret = true;
  ...
  public void testListAll() throws Exception {
    ...
    assertTrue(compareDO(employeeDTO1, (EmployeeDTO) employeeList.get(0)));
    assertTrue(compareDO(employeeDTO2, (EmployeeDTO) employeeList.get(1)));
  ...
  public void testListAllLimOff() throws Exception {
    ...
    assertEquals(1, employeeList.size());
    assertTrue(compareDO(employeeDTO2, (EmployeeDTO) employeeList.get(0)));
