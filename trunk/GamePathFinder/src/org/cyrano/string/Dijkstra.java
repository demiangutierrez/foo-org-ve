...
public class Dijkstra {
  ...
  private Map<Integer, Data> nodeDataByNodeMap = new HashMap<Integer, Data>();
  private Integer node;

  // --------------------------------------------------------------------------------

  public Dijkstra(Map<Integer, Set<Integer>> graph, Integer node) {
    this.node = node;
    ...
    while (true) {
      ...
      for (Integer edge : graph.get(curr)) {
