...
public class TextMap {
  ...
  private List<GhostBean> ghostBeanList = new ArrayList<GhostBean>();
  ...
  public void load(String filename) throws Exception {
    ...
    data = new char[w][h];
    item = new ItemBean[w][h]; // TODO: Improve
    ...
    while ((line = rd.readLine()) != null) {
      ...
      ghostBeanList.add(new GhostBean(line));
    }
    ...
    while ((line = rd.readLine()) != null) {
      ...
      ItemBean itemBean = new ItemBean(line);
      itemBeanList.add(itemBean);
      item[itemBean.getX()][itemBean.getY()] = itemBean; // One layer so far
    }
  }

  // --------------------------------------------------------------------------------

  public List<GhostBean> getGhostBeanList() {
    return ghostBeanList;
  }
