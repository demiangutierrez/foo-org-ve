...
public class InputWindow extends WindowPane {
  ...
  protected void btnAaaClicked(ActionEvent evt) {
    fireCustomABCEvent(new CustomABCEvent(this, txtField.getText()), Method.AAA);
  }

  protected void btnBbbClicked(ActionEvent evt) {
    fireCustomABCEvent(new CustomABCEvent(this, txtField.getText()), Method.BBB);
  }

  protected void btnCccClicked(ActionEvent evt) {
    fireCustomABCEvent(new CustomABCEvent(this, txtField.getText()), Method.CCC);
  }
