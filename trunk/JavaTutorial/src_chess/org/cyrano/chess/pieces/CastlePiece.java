 ...
 */
public class CastlePiece extends AbstractPiece
{
	...
	static {
		...
		try
		{
			whiteImage = ImageIO.read(ClassLoader.getSystemResourceAsStream("org/cyrano/chess/images/WhiteCastle.png"));
			blackImage = ImageIO.read(ClassLoader.getSystemResourceAsStream("org/cyrano/chess/images/BlackCastle.png"));
		}
		catch (IOException e)
		{
			e.printStackTrace();
	 ...
	 * 
	 */
	public CastlePiece(int currI, int currJ)
	{
		super(currI, currJ);
	}
	...
	{
		return castleMove(i, j, board, false);
	}
