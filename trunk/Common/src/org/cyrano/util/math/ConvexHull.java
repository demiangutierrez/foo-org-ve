...
public class ConvexHull {
  ...
  // TODO: Fix, there should be a super class of PointDbl with accesors to x & y
  public static List<PointDbl> convexHull(PointDbl[] pointArray) {
    ...
    do {
      ...
      for (int curr = 0; curr < pointArray.length; curr++) {
        ...
        double x1 = pointArray[curr].x - pointArray[prev].x;
        double x2 = pointArray[next].x - pointArray[prev].x;
        double y1 = pointArray[curr].y - pointArray[prev].y;
        double y2 = pointArray[next].y - pointArray[prev].y;
