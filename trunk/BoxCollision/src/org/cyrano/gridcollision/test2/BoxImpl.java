package org.cyrano.gridcollision.test2;
...
public class BoxImpl implements Box {
  ...
  public void draw(Graphics2D g2d) {
    ...
    for (PointBean pointBean : pointList) {
      ...
      Point end = new Point(beg.x + sx - cx, beg.y + sy - cy);
      ...
      if (pointBean.axis == Axis.HOR) {
        gciList = GridCollisionDetector.calculateVerPointList(beg, end, GamePanel.GRID_SIZE);
        g2d.setColor(Color.YELLOW);
      } else {
        gciList = GridCollisionDetector.calculateHorPointList(beg, end, GamePanel.GRID_SIZE);
