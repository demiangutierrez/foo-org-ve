...
public class ByCriteria {
  ...
  public static void main(String[] args) {
    ...
    criteria = session.createCriteria(SearchObj.class).add(Restrictions.ge("num", 7));
    list(criteria);
    ...
    criteria = session.createCriteria(SearchObj.class).add(Restrictions.like("codigo", "%ab")).addOrder(
        Order.asc("num"));
    list(criteria);
